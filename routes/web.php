...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:stagiaire')->group(function () {
        ...
        Route::get('/offres/{internship}',       [InternshipController::class, 'show'])->name('offres.show');
    ...
    Route::middleware('role:entreprise')->group(function () {
        ...
        Route::get('/offres/{internship}/edit',          [InternshipController::class, 'edit'])->name('offres.edit');
        Route::patch('/offres/{internship}',             [InternshipController::class, 'update'])->name('offres.update');
        Route::delete('/offres/{internship}',            [InternshipController::class, 'destroy'])->name('offres.destroy');
